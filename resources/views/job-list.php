        ...
        <div class="tab-content mt-4">
            <div class="tab-pane fade active show" id="Boxed" role="tabpanel">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="jobs2 text-center card-body">
                                <div class="text-center">
                                    ...
                                    <span class="text-primary mb-3 d-block">5 Vacancies</span>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="card">
                            <div class="jobs2 text-center card-body">
                                <div class="text-center">
                                    ...
                                    <h4 class="fs-20 mb-0">Php Developer</h4>
                                    <span class="text-primary mb-3 d-block">5 Vacancies</span>
                                </div>
                                <div class="mb-3">
                                    <span class="badge badge-success badge-lg light abs-status">Active</span>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card">
                            <div class="jobs2 text-center card-body inactive">
                                <div class="text-center">
                                    <span class="job_list_icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                                    ...
                                    <h4 class="fs-20 mb-0">Digital Marketer</h4>
                                    <span class="text-primary mb-3 d-block">5 Vacancies</span>
                                </div>
                                <div class="mb-3">
                                    <span class="badge badge-danger badge-lg light abs-status">InActive</span>
                                    <span class="d-block mb-1"><i class="text-primary font-normal">Posted Date:</i> 12-01-2021</span>
                                    <span class="d-block mb-1"><i class="text-primary font-normal">Last Date:</i> 20-01-2021</span>
                                </div>
                                <div class="action-buttons d-flex justify-content-center">
                        ...
                        <div class="card">
                            <div class="jobs2 text-center card-body">
                                <div class="text-center">
                                    ...
                                    <h4 class="fs-20 mb-0">Content Writer</h4>
                                    <span class="text-primary mb-3 d-block">5 Vacancies</span>
                                </div>
                                <div class="mb-3">
                                    <span class="badge badge-success badge-lg light abs-status">Active</span>
